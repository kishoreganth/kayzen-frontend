...
import { setGender, setVoice, setStability, setSimilarity, setExaggeration, setSpeakerBoost, setAdvancedSetting } from '../../store/actions/voiceSettingActions'
    ...
    <div className={`w-full Hmd h-screen relative flex flex-col justify-center items-center  ${theme === 'dark' ? 'bg-[#1D2027] text-white' : 'bg-[#F2F4F7] text-black'}`}>
      ...
      <div className='w-[75vw] h-fit  rounded-[0.417vw] flex flex-col items-start gap-[1vw] overflow-hidden transition-all duration-1000'>
        ...
        <div className={`w-full rounded-[0.417vw] shadow-lg flex flex-col justify-center py-[1vw] transition-all duration-1000 ${theme === 'dark' ? 'bg-[#1D2027] text-white' : 'bg-white text-black'} ${!advancedSetting ? 'h-[42vh]' : 'h-[74.68vh]'}`}>
          <div className='w-full h-[12vh] bg-red- flex flex-col px-[2vw] py-[.5vh] gap-[1vw] '>
            <label className='text-[1.042vw] capitalize' htmlFor="gender">gender</label>
            <select value={gender} onChange={(e) => dispatch(setGender(e.target.value))} className='Hmd bg-transparent border-[0.052vw] border-zinc-300 py-[.8vh] px-[.5vw] rounded-[0.417vw] focus:outline-none focus:ring-2 focus:ring-pink-200  ' name="gender" id="gender">
          ...
          <div className='w-full h-[12vh] bg-red- flex flex-col px-[2vw] py-[.5vw] gap-[1vw] '>
            <label className='text-[1.042vw] capitalize' htmlFor="gender">voice & preview</label>
            <select value={voice} onChange={(e) => dispatch(setVoice(e.target.value))} className='h-[3vw] Hmd bg-transparent border-[0.052vw] border-zinc-300 py-[.8vh] px-[.5vw] rounded-[0.417vw] focus:outline-none focus:ring-2 focus:ring-pink-200 ' name="gender" id="gender">
      ...
      <div className={`w-full absolute bottom-0 h-[6.5vh]  ${theme === "dark" ? 'bg-[#1F222A] text-white' : 'bg-white text-black'}`}>
        <div className='w-full h-full flex justify-end items-center gap-[2vw] px-[3vw] '>
          <GradientButton
            text='back'
            onClick={() => navigate.push('/workspace/agents/phone/toolcreation')}
          />
