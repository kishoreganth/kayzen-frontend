...
import DemoBot from './chatSettings/playground/DemoBot';
                ...
                <div className="w-full h-screen">
                    ...
                    <div className="flex justify-end gap-[8vw]">
                        <div className="w-[40vw] h-[80vh] mt-[3vw] rounded-[0.833vw] shadow-xl py-[2vw] relative">
                            <h1 className="text-[1.25vw] capitalize text-center pb-[2vw] mb-[2vw]">
                            ...
                            <div className="flex flex-col gap-[2vw] px-[3vw] items-center">
                                ...
                                <div className='flex flex-col gap-[0.417vw] mt-[8vw]'>
                                    <label className='capitalize text-[1.042vw] font-medium'>
    ...
    return <>
       ...
       renderSkeleton()
        ...
        <div className={`w-full h-screen overflow-y-auto relative ${theme === "dark" ? 'bg-[#1F222A] text-white' : 'bg-[#F2F4F7] text-black'}`}>
            ...
            <div className='w-full h-[80vh] flex justify-center items-center gap-[3vw] '>
                <div className={`w-1/2 h-[77vh]  rounded-[0.833vw] shadow-xl py-[2vw] relative ${theme === "dark" ? 'bg-[#1F222A] text-white' : 'bg-white text-black'}`}>
                    ...
                    <div className='flex flex-col gap-[2vw] mt-[1vh] px-[2vw] items-center'>
                        ...
                        <div className='flex flex-col gap-[0.417vw] mt-[10vh] w-[35vw] h-[40vh] text-[1vw]'>
                            {/* <MyCodeComponent /> */}
                            <label htmlFor="embed" className='capitalize text-[1.042vw]'>Embed Code</label>
                            <CopyBlock
                ...
                <Chatbot height={"77vh"} chatAgentId={chatAgentId} loading={loading} />
            </div>
